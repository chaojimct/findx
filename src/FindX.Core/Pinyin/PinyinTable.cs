...
public static class PinyinTable
{
    ...
    private static void FillCommonCharacters()
    {
        var bulk = new Dictionary<string, string>
        {
            ...
            ["才材采彩菜参餐残藏操草策层曾察茶查差拆产昌尝常场厂唱超朝潮车彻沉陈称城成程承诚吃冲虫抽仇丑出初除础楚处触川穿船窗床创春纯词此次聪从粗促存错"] = "cai,cai,cai,cai,cai,can,can,can,cang,cao,cao,ce,ceng,ceng,cha,cha,cha,cha,chai,chan,chang,chang,chang,chang,chang,chang,chao,chao,chao,che,che,chen,chen,chen,cheng,cheng,cheng,cheng,cheng,chi,chong,chong,chou,chou,chou,chu,chu,chu,chu,chu,chu,chu,chuan,chuan,chuan,chuang,chuang,chuang,chun,chun,ci,ci,ci,cong,cong,cu,cu,cun,cuo",
            ["达答打带待袋戴丹单胆旦但蛋弹岛导倒盗到道德灯登等低底抵敌的滴敌地弟递第点典电店淀调掉丁顶定丢冬东董懂洞动冻都斗豆毒独读度渡短断段锻堆队对吨蹲顿多夺朵"] = "da,da,da,dai,dai,dai,dai,dan,dan,dan,dan,dan,dan,dao,dao,dao,dao,dao,dao,de,deng,deng,deng,di,di,di,di,de,di,di,di,di,di,dian,dian,dian,dian,dian,diao,diao,ding,ding,ding,diu,dong,dong,dong,dong,dong,dong,dong,dou,dou,dou,du,du,du,du,du,duan,duan,duan,duan,dui,dui,dui,dun,dun,dun,duo,duo,duo",
            ["额恩耳二"] = "e,en,er,er",
            ["法帆翻凡烦反返范犯饭方房防妨仿访纺放飞非肥废费分纷芬坟粉份丰风封疯锋逢缝凤否夫扶服浮福符幅辐抚府腐父付妇附复赋富腹覆"] = "fa,fan,fan,fan,fan,fan,fan,fan,fan,fan,fang,fang,fang,fang,fang,fang,fang,fei,fei,fei,fei,fei,fen,fen,fen,fen,fen,fen,feng,feng,feng,feng,feng,feng,feng,feng,fou,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu,fu",
            ["该改盖概感敢赶干刚钢高搞稿告哥歌革格隔个各给根跟更工公功攻供宫恭巩共勾沟狗构购够估古骨谷股故顾固瓜挂拐怪关观官管馆惯灌光广归龟规轨鬼贵桂滚锅国果过"] = "gai,gai,gai,gai,gan,gan,gan,gan,gang,gang,gao,gao,gao,gao,ge,ge,ge,ge,ge,ge,ge,gei,gen,gen,geng,gong,gong,gong,gong,gong,gong,gong,gong,gou,gou,gou,gou,gou,gou,gu,gu,gu,gu,gu,gu,gu,gua,gua,guai,guai,guan,guan,guan,guan,guan,guan,guan,guang,guang,gui,gui,gui,gui,gui,gui,gun,guo,guo,guo,guo",
            ["哈海害含寒喊汉汗旱航毫豪好号耗喝河合何核荷盒贺黑恨很横衡红宏洪虹厚后猴吼呼忽狐胡湖壶虎互户护花华滑化划画话怀坏欢环还换唤患荒慌皇黄灰恢挥辉回汇毁悔会绘惠慧婚混活火伙或货获"] = "ha,hai,hai,han,han,han,han,han,han,hang,hao,hao,hao,hao,hao,he,he,he,he,he,he,he,he,hei,hen,hen,heng,heng,hong,hong,hong,hong,hou,hou,hou,hou,hu,hu,hu,hu,hu,hu,hu,hu,hu,hu,hua,hua,hua,hua,hua,hua,hua,huai,huai,huan,huan,hai,huan,huan,huan,huang,huang,huang,huang,hui,hui,hui,hui,hui,hui,hui,hui,hui,hui,hun,hun,huo,huo,huo,huo,huo",
            ["机鸡积基激及吉极即级急疾集籍几己济记纪既技际季计继寂绩加家佳夹嘉甲假价架驾嫁歼坚尖检简减剪建件健渐践鉴键箭江姜将浆奖讲降酱交郊骄胶焦角脚教较接揭街阶节结劫杰洁姐解介戒届界今金斤仅紧锦尽近进晋禁京经惊精井景警净竞境静镜敬究九酒久救就旧居局菊橘举巨句拒具距聚卷决绝觉军均君"] = "ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,ji,jia,jia,jia,jia,jia,jia,jia,jia,jia,jia,jian,jian,jian,jian,jian,jian,jian,jian,jian,jian,jian,jian,jian,jian,jiang,jiang,jiang,jiang,jiang,jiang,jiang,jiao,jiao,jiao,jiao,jiao,jiao,jiao,jiao,jie,jie,jie,jie,jie,jie,jie,jie,jie,jie,jie,jie,jin,jin,jin,jin,jin,jin,jin,jin,jin,jin,jing,jing,jing,jing,jing,jing,jing,jing,jing,jing,jiu,jiu,jiu,jiu,jiu,jiu,ju,ju,ju,ju,ju,ju,ju,ju,ju,juan,jue,jue,jue,jun,jun,jun",
            ["开揭凯刊勘看康抗考烤靠科棵颗壳可渴克刻客课肯坑空孔恐控口扣枯哭苦库裤酷快宽款狂况矿亏葵昆困扩括"] = "kai,jie,kai,kan,kan,kan,kang,kang,kao,kao,kao,ke,ke,ke,ke,ke,ke,ke,ke,ke,ken,keng,kong,kong,kong,kong,kou,kou,ku,ku,ku,ku,ku,ku,kuai,kuan,kuan,kuang,kuang,kuang,kui,kui,kun,kun,kuo,kuo",
            ["拉啦来赖兰蓝篮栏拦懒烂滥郎朗浪劳牢老姥雷累泪类冷离梨黎礼李里理力历立丽利励例隶粒俩连联莲怜帘脸练炼链良凉梁粮两辆亮谅疗辽料列烈裂猎林临邻领灵铃凌零另令留流柳六龙聋隆楼漏露卢芦鲁陆录路绿驴律虑率略轮论罗萝逻落骆"] = "la,la,lai,lai,lan,lan,lan,lan,lan,lan,lan,lan,lang,lang,lang,lao,lao,lao,lao,lei,lei,lei,lei,leng,li,li,li,li,li,li,li,li,li,li,li,li,li,li,lian,lian,lian,lian,lian,lian,lian,lian,liang,liang,liang,liang,liang,liang,liang,liao,liao,liao,lie,lie,lie,lie,lin,lin,lin,ling,ling,ling,ling,ling,ling,ling,liu,liu,liu,liu,long,long,long,lou,lou,lu,lu,lu,lu,lu,lu,lv,lv,lv,lv,lv,lv,lun,lun,luo,luo,luo,luo,luo",
            ...
            ["七妻期欺齐其棋奇骑旗企启起气弃器千迁签铅前钱浅遣歉枪腔强墙抢悄巧桥乔侨瞧切茄且窃亲琴勤青轻氢倾清情晴请庆穷丘秋球求区曲取趣去圈权全泉拳犬劝缺却确裙群"] = "qi,qi,qi,qi,qi,qi,qi,qi,qi,qi,qi,qi,qi,qi,qi,qian,qian,qian,qian,qian,qian,qian,qian,qian,qiang,qiang,qiang,qiang,qiang,qiao,qiao,qiao,qiao,qiao,qiao,qie,qie,qie,qie,qin,qin,qin,qing,qing,qing,qing,qing,qing,qing,qing,qiong,qiu,qiu,qiu,qiu,qu,qu,qu,qu,qu,quan,quan,quan,quan,quan,quan,que,que,que,qun,qun",
            ...
            ["洒撒塞赛三伞散桑嗓丧扫嫂色森杀沙纱傻啥晒山删闪善伤商赏上尚烧稍少绍奢舌蛇设射摄社舍申伸身深神审慎升生声胜绳省圣盛剩尸失师诗施湿十什石识时实拾食史始驶士示世市事势视试饰室是释收手守首受寿授售书叔殊舒输蔬熟鼠属术束述树竖数刷耍衰摔甩帅双霜爽谁水睡顺说丝司私思斯死四似寺松宋送诵搜艘苏俗素速宿塑酸蒜算虽随岁碎孙损缩所索锁"] = "sa,sa,sai,sai,san,san,san,sang,sang,sang,sao,sao,se,sen,sha,sha,sha,sha,sha,shai,shan,shan,shan,shan,shang,shang,shang,shang,shang,shao,shao,shao,shao,she,she,she,she,she,she,she,shen,shen,shen,shen,shen,shen,shen,sheng,sheng,sheng,sheng,sheng,sheng,sheng,sheng,sheng,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shi,shou,shou,shou,shou,shou,shou,shou,shu,shu,shu,shu,shu,shu,shu,shu,shu,shu,shu,shu,shu,shua,shua,shuai,shuai,shuai,shuai,shuang,shuang,shuang,shui,shui,shui,shun,shuo,si,si,si,si,si,si,si,song,song,song,song,sou,sou,su,su,su,su,su,su,suan,suan,suan,sui,sui,sui,sui,sun,sun,suo,suo,suo",
            ["他她它踏台太态抬摊滩坛谈弹毯探叹汤唐堂塘糖躺趟掏逃桃陶淘讨套特疼腾梯踢提题蹄体替天田甜添填挑条跳贴铁厅听庭停亭挺通同铜童统痛偷头投透突图徒途涂土吐兔团推退吞屯托脱拖"] = "ta,ta,ta,ta,tai,tai,tai,tai,tan,tan,tan,tan,dan,tan,tan,tan,tang,tang,tang,tang,tang,tang,tang,tao,tao,tao,tao,tao,tao,tao,te,teng,teng,ti,ti,ti,ti,ti,ti,ti,tian,tian,tian,tian,tian,tiao,tiao,tiao,tie,tie,ting,ting,ting,ting,ting,ting,tong,tong,tong,tong,tong,tong,tou,tou,tou,tou,tu,tu,tu,tu,tu,tu,tu,tuan,tui,tui,tun,tun,tuo,tuo,tuo",
            ["挖哇娃瓦歪外弯湾丸完玩晚碗万汪王网往忘旺望危威微巍违围唯维伟尾纬未位味畏胃卫温文闻蚊稳问翁窝我沃握乌污屋无吴五午武舞务物误雾"] = "wa,wa,wa,wa,wai,wai,wan,wan,wan,wan,wan,wan,wan,wang,wang,wang,wang,wang,wang,wei,wei,wei,wei,wei,wei,wei,wei,wei,wei,wei,wei,wei,wei,wei,wen,wen,wen,wen,wen,wen,weng,wo,wo,wo,wo,wu,wu,wu,wu,wu,wu,wu,wu,wu,wu,wu",
            ["西吸希析息牺悉惜稀溪锡熙膝习席袭洗喜戏系细瞎虾峡狭下吓夏仙先鲜纤咸贤弦闲显险县现线宪陷献乡相香箱湘想响享项象像橡消削小晓孝笑效校些歇协写血泄卸屑谢心辛新信星兴形型醒杏姓幸性凶兄胸雄休修秀袖绣虚需许叙序续蓄宣悬选旋穴学雪血勋寻巡训讯迅压呀牙芽崖丫鸦雅"] = "xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xi,xia,xia,xia,xia,xia,xia,xia,xian,xian,xian,xian,xian,xian,xian,xian,xian,xian,xian,xian,xian,xiang,xiang,xiang,xiang,xiang,xiang,xiang,xiang,xiang,xiang,xiang,xiao,xiao,xiao,xiao,xiao,xiao,xiao,xiao,xie,xie,xie,xie,xie,xie,xie,xie,xie,xin,xin,xin,xin,xing,xing,xing,xing,xing,xing,xing,xing,xiong,xiong,xiong,xiong,xiu,xiu,xiu,xiu,xiu,xu,xu,xu,xu,xu,xu,xu,xuan,xuan,xuan,xuan,xue,xue,xue,xue,xun,xun,xun,xun,xun,ya,ya,ya,ya,ya,ya,ya,ya",
            ["烟淹盐严颜阎延言岩沿眼演验焰宴燕央扬阳杨洋仰养样腰遥摇药要邀耀爷也野业叶页夜液一衣医依壹宜移仪遗疑已以蚁义亿忆艺议译易益谊因阴音银引饮印应英婴樱营影迎映硬赢用尤由油游犹有友右又幼于与宇语羽雨玉预域欲育遇愈元园原员圆援源远院愿约月越跃阅云允运晕韵孕"] = "yan,yan,yan,yan,yan,yan,yan,yan,yan,yan,yan,yan,yan,yan,yan,yang,yang,yang,yang,yang,yang,yang,yang,yao,yao,yao,yao,yao,yao,yao,ye,ye,ye,ye,ye,ye,ye,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yi,yin,yin,yin,yin,yin,yin,ying,ying,ying,ying,ying,ying,ying,yong,you,you,you,you,you,you,you,you,you,yu,yu,yu,yu,yu,yu,yu,yu,yu,yu,yu,yu,yuan,yuan,yuan,yuan,yuan,yuan,yuan,yuan,yuan,yue,yue,yue,yue,yun,yun,yun,yun,yun,yun",
            ["杂砸灾栽载再在赞暂脏藏葬遭糟早澡造则责择泽贼怎增赠扎眨炸摘宅窄寨占战站张章彰障招找召兆赵照罩遮折哲者这针侦珍真阵振震镇争征整正证政郑挣睁蒸织职直值植殖指止址纸志至致制质治秩智置中终忠钟种肿众周洲舟粥州轴宙昼皱骤猪珠竹蛛主柱注住驻助祝著筑抓爪专砖转赚庄装壮撞追准捉桌着资姿紫字自宗综踪总纵走奏租族足阻组祖嘴最罪醉尊遵昨左坐座做"] = "za,za,zai,zai,zai,zai,zai,zan,zan,zang,zang,zang,zao,zao,zao,zao,zao,ze,ze,ze,ze,zei,zen,zeng,zeng,zha,zha,zha,zhai,zhai,zhai,zhai,zhan,zhan,zhan,zhang,zhang,zhang,zhang,zhao,zhao,zhao,zhao,zhao,zhao,zhao,zhe,zhe,zhe,zhe,zhen,zhen,zhen,zhen,zhen,zhen,zhen,zheng,zheng,zheng,zheng,zheng,zheng,zheng,zheng,zheng,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhi,zhong,zhong,zhong,zhong,zhong,zhong,zhou,zhou,zhou,zhou,zhou,zhou,zhou,zhou,zhou,zhu,zhu,zhu,zhu,zhu,zhu,zhu,zhu,zhu,zhu,zhu,zhua,zhua,zhuan,zhuan,zhuan,zhuan,zhuang,zhuang,zhuang,zhuang,zhui,zhun,zhuo,zhuo,zhuo,zi,zi,zi,zi,zi,zong,zong,zong,zong,zong,zou,zou,zu,zu,zu,zu,zu,zui,zui,zui,zun,zun,zuo,zuo,zuo,zuo,zuo",
        };
