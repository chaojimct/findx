...
pub struct Cli {
    ...
    /// index.bin 路径
    #[arg(short, long, default_value = "index.bin", global = true)]
    pub index: PathBuf,

    /// USN 卷（须与建索引一致）
    #[arg(short, long, default_value = "C:", global = true)]
    pub volume: String,

    /// 命名管道名（实际为 \\\\.\\pipe\\<名称>）
    #[arg(short, long, default_value = "findx2", global = true)]
    pub pipe: String,
    ...
    #[arg(long = "exclude-dir", value_name = "PATH", global = true)]
